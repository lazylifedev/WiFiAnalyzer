...
@Database(
    entities = [WorkspaceEntity::class, RegisteredWifiDeviceEntity::class, WifiDeviceBssidEntity::class, WifiDeviceGroupEntity::class, DevicePhotoEntity::class, PendingFileDeletionEntity::class, KintoneConnectionEntity::class, SignalHistoryEntity::class],
    ...
    companion object {
        ...
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("CREATE INDEX IF NOT EXISTS `index_signal_history_workspace_id_bssid_timestamp_millis` ON `signal_history` (`workspace_id`, `bssid`, `timestamp_millis`)")
                db.execSQL("CREATE INDEX IF NOT EXISTS `index_signal_history_timestamp_millis` ON `signal_history` (`timestamp_millis`)")
            }
        }
